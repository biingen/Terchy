...
namespace Terchy
{
    ...
    public class Crc16
    {
        ...
        public static string PID_CRC16(string orginal_data)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Please check HEX command format.", "Format error");
            }
    ...
    public static class HexConverter
    {
        ...
        public static byte[] StrToByte(this string hexString)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    System.Windows.Forms.MessageBox.Show("Please check your schedule is in hexadecimal format.", "Format error");
                }
            }
